...
<p align="center">
  <a href="mailto:me@boytwigg.com">me@boytwigg.com</a> · <a href="https://boytwigg.com">boytwigg.com</a>
</p>
...
BoyTwigg Consulting helps organizations replace manual, disconnected processes with unified, automated systems — and equips individuals with AI-powered tools to multiply their output. We work across the full operations stack, from discovery and audit through implementation and delivery, and design purpose-built AI agents for venture capital firms, executives, and small businesses.
...
**AI & Agent Platforms**
`Tasklet` `OpenAI` `Retell AI` `Custom AI Workflows`

**Platforms & CRM**
`Airtable` `Notion` `Anytype` `HubSpot` `Carta`

**Automation**
`Zapier` `Make (Integromat)` `Custom Webhooks` `API Integration`

**Scheduling & Payments**
`Cal.com` `Calendly` `Stripe` `LawPay`

**Communication**
`Dialpad` `Twilio` `Mailchimp` `Acumbamail`

**Document & E-Signature**
`Proof.com` `DocuSign` `PandaDoc`

**Development & Data**
`Python` `REST APIs` `JSON/CSV Transformation` `ReportLab` `Markdown`

**Research & Analysis**
`Vendor evaluation frameworks` `Pricing analysis` `Compliance assessment`
...
### 🚀 BAG Ventures — AI Agent Team Architecture

**Client:** [BAG Ventures](https://bagvc.com) · Pre-Seed/Seed VC · Enterprise AI Focus

**Scope:** Design and deploy a team of five purpose-built AI agents to automate core firm operations across deal flow, portfolio management, fund operations, daily operations, and fellowship program management.

**What we designed & built:**

| Agent | Domain | What It Does |
|-------|--------|-------------|
| **Dante** | Deal Flow & Pipeline | Automated deal intake, company enrichment, fit scoring against investment thesis, pipeline tracking, weekly deal flow summaries |
| **Priya** | Portfolio Intelligence | Portfolio company monitoring (news, hiring, funding), quarterly data collection, founder support routing, competitive intelligence |
| **Fletcher** | Fund Operations | LP prospecting & outreach sequencing, capital call tracking, legal document management, compliance monitoring, Carta integration |
| **Oscar** | Day-to-Day Ops | Intelligent email triage, meeting prep & follow-ups, calendar optimization, travel coordination, weekly operational briefings |
| **Emery** | Education & Fellowship | Application pipeline management, program coordination, fellow progress tracking, alumni community management, content creation |

**Key outcomes:**
- 5 AI agents covering the firm's entire operational surface area
- Each agent purpose-built with domain-specific knowledge and integrations
- Cost-effective deployment — full agent team at a fraction of a single hire
- Designed for a firm managing a portfolio that includes companies like Superface, Lanai, Nomadic, Defendermate, and BizTrip

---

### 🎯 Executive AI Agent Suite — Full C-Suite for One

**Client:** High-powered executive · Enterprise client roster
...
|-------|--------|----------|
| **Operations Command** | Production & Project Management | Owns project boards across 15+ active workstreams. Surfaces risks before they become problems. Manages delegation to key team members with context and rationale — not just task assignments. Delivers weekly production pulses and deadline intelligence. |
| **Client Intelligence** | Growth & Relationship Strategy | Pre-meeting prep engine with full relationship context. Proposal drafting that matches the executive's voice. Pipeline and OKR tracking. Follow-up discipline — nothing falls through the cracks. |
| **Brand Voice** | Communications & Content | Email drafting and triage in the executive's authentic voice. LinkedIn content strategy. Portfolio and case study development. Maintains a living style guide that evolves with the brand. |
| **Life Operations** | Personal & Wellness | Weekly planning rituals. Relationship maintenance prompts. Wellness and routine support. Life admin (bills, appointments, subscriptions). The agent that protects the person behind the professional. |
...
### 🏛️ Solo Law Practice — Full-Stack Operations Buildout

**Client:** Solo family law practice · 5 counties · Legacy systems

**Scope:** End-to-end systems overhaul for a solo attorney managing cases across five counties with no centralized CRM, no automation, and a legacy platform approaching end-of-life.

**What we delivered:**
- Migrated **844 contacts**, **31 matters**, and **25 billing records** from a legacy CRM with zero data loss
...
| **Mental Wellness** | How automation reduces cognitive load. Why entrepreneurship + AI is a mental health strategy. Embedded wellness, not bolted-on. |
...
Alex Malebranche is a multiple-time founder, keynote speaker, and mental health advocate with 15+ years of experience across tech and the military.

**Tech:** AWS · GitHub · Amazon · Cloudflare · Plume Design
**Military:** U.S. Army
**Ventures:** Antler · Perplexity

He builds systems that make people and organizations faster, sharper, and more resilient — whether that's an AI agent team running a VC firm's operations, an automation platform managing a law practice, or a workshop equipping student athletes with tools for life after sports.

## Repository Structure

```
├── README.md                ← You are here
├── portfolio/               ← Case studies and deliverable samples
│   ├── case-study.pdf
│   ├── workflow-review.pdf
...
📧 **me@boytwigg.com**
🌐 **[boytwigg.com](https://boytwigg.com)**

---

<p align="center">
  <sub>© 2026 BoyTwigg Consulting. Select portfolio materials are redacted to protect client confidentiality.</sub>
</p>
